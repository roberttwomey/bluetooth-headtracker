...
//final String serialPort = "/dev/tty.usbserial-A9A99ZVR";
final String serialPort = "/dev/tty.AdafruitEZ-Link157f-SPP"; // replace this with your serial port. On windows you will need something like "COM1".
//final String serialPort = "/dev/tty.AdafruitEZ-Link416c-SPP"; // replace this with your serial port. On windows you will need something like "COM1".
//final String serialPort = "/dev/tty.AdafruitEZ-Link3e2f-SPP"; // replace this with your serial port. On windows you will need something like "COM1".
//final String serialPort = "/dev/tty.usbserial-AH02LTVP";
